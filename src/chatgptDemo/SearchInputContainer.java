...
public class SearchInputContainer extends HorizontalFieldManager {
	HorizontalFieldManager inputFieldWrapper;
	SearchInputField inputField;
	SendListener listener;

	public SearchInputContainer() {
		...
		inputField = new SearchInputField("", " Search", 500, EditField.EDITABLE
